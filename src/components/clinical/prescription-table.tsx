        ...
        <div key={field.id} className="clay-inset p-4 space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="space-y-1.5">
              <Label className="text-[10px] font-semibold text-slate-500 uppercase tracking-wider">Medicamento</Label>
              <Input placeholder="Nombre del medicamento" className="clay-input h-10 text-slate-900" {...form.register(`prescriptions.${index}.medication`)} />
            </div>
            <div className="space-y-1.5">
            ...
            <div className="space-y-1.5">
              ...
              <Textarea placeholder="1 sobre diario despues de almuerzo" className="clay-input min-h-[40px] text-sm text-slate-900 resize-none" {...form.register(`prescriptions.${index}.instructions`)} />
            </div>
          </div>
        </div>
      ))}
